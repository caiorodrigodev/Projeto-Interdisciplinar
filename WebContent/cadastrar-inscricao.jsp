	...
	<form action="CadastrarInscricao.do" method="post">
		...
		<div class="form-row">
			...
			<div class="form-group col-md-6">
				<label>Telefone</label>
				 <input type="text" name="inputTelefone" class="form-control" placeholder="(11) 9 8521-4563" required>
			</div>
		</div>
		...
		<div class="form-row">
			<div class="form-group col-md-4">
				...
				<input type="text" name="inputDtNascimento" class="form-control" placeholder="31 / 02 / 1999" minlenth="5" maxlength="10" required>
			</div>
...
<%
String respostaCadastrarInscricao = (String)request.getSession().getAttribute("tryCadastrarInscricao");

String scriptCadastrarInscricao = "";
					
if(respostaCadastrarInscricao == null) {
	respostaCadastrarInscricao = "";
} else {
	scriptCadastrarInscricao = "alert('" + respostaCadastrarInscricao + "');";
	request.getSession().setAttribute("tryCadastrarInscricao", null);
}

%>

<script>
<%=scriptCadastrarInscricao%>
</script>
</div>
